/*************************************************** 
  ...
  Use Arduino board type "ATMEGA 168 (internal 8 MHZ clock)"
  
  new chips from the factory are 1 MHZ internal osc, so program fuses using:
  avrdude -patmega168p -cstk500v2 -Pusb -U lfuse:w:0xa2:m -U hfuse:w:0xde:m -U efuse:w:0xf8:m
  - or -
  avrdude -patmega168 -cstk500v2 -Pusb -U lfuse:w:0xa2:m -U hfuse:w:0xde:m -U efuse:w:0xf8:m
  ... depending on the type of ATMEGA168 you have
 ****************************************************/
...
// function shortBeep()
//
// plays a short beep synchronously
//---------------------------------------------------------------------------------------------//
void shortBeep()
{
  toneAC(NOTE_A7, 10, 30, 0);
  toneAC(0);
}
